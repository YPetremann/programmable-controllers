...
return {
   ["pc-cpu"] = {
      on_gui_create = function(index, entity, player)
         ...
         local action = gui.add {type = "flow", name = "flow-" .. index, direction = "horizontal"}
         local btn = action.add {type = "button", name = "pc-reset", caption = "Reset", style = "back_button"}
         btn.style.maximal_width = 83
         btn = action.add {type = "button", name = "pc-pause", caption = "Pause", style = "dialog_button"}
         btn.style.maximal_width = 82
         btn = action.add {type = "button", name = "pc-start", caption = "Start", style = "forward_button"}
         btn.style.maximal_width = 83
         gui.add {type = "progressbar", name = "cycles", size = 256, value = 0}
      ...
      on_built_entity = function(entity)
         ...
         local eid = pc_utils.cantorPair(math.floor(entity.position.x), math.floor(entity.position.y))
         ...
         parameters.parameters[2] = {signal = {type = "virtual", name = "pci-10"}, count = index, index = 2}
         parameters.parameters[3] = {signal = {type = "virtual", name = "signal-blue"}, count = 0, index = 3}
         parameters.parameters[4] = {signal = {type = "virtual", name = "signal-green"}, count = 0, index = 4}
         parameters.parameters[5] = {signal = {type = "virtual", name = "signal-yellow"}, count = 0, index = 5}
         parameters.parameters[6] = {signal = {type = "virtual", name = "signal-red"}, count = 0, index = 6}
         parameters.parameters[7] = {signal = {type = "virtual", name = "signal-C"}, count = 0, index = 7}
         parameters.parameters[8] = {signal = {type = "virtual", name = "signal-O"}, count = 0, index = 8}
         parameters.parameters[9] = {signal = {type = "virtual", name = "signal-D"}, count = 0, index = 9}
         parameters.parameters[10] = {signal = {type = "virtual", name = "signal-E"}, count = 0, index = 10}
         parameters.parameters[11] = {signal = {type = "virtual", name = "signal-blue"}, count = 0, index = 11}
         parameters.parameters[12] = {signal = {type = "virtual", name = "signal-blue"}, count = 0, index = 12}
         parameters.parameters[13] = {signal = {type = "virtual", name = "signal-H"}, count = 0, index = 13}
         parameters.parameters[14] = {signal = {type = "virtual", name = "signal-E"}, count = 0, index = 14}
         parameters.parameters[15] = {signal = {type = "virtual", name = "signal-R"}, count = 0, index = 15}
         parameters.parameters[16] = {signal = {type = "virtual", name = "signal-E"}, count = 0, index = 16}
      ...
      on_tick = function(eid, entity, energy)
         ...
         if entity.get_control_behavior().enabled and energy[grp] ~= nil and energy[grp][1] > power then
            ...
            if state.signal.name == "pci-0E" or state.signal.name == "pci-0F" then
      ...
      on_removed_entity = function(entity)
      end,
   },
}
